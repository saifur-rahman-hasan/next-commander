...
export default function RolesTable({
  ...
  const {
    ...
    isValidating,
    mutate,
  } = useSWR("/api/authorization/roles", fetcher);
  ...
  const deleteRoleData = async (id: string) => {
    if (confirm("Are you sure you want to delete this user?")) {
      const response = await fetch(`/api/authorization/roles/${id}`, {
        method: "DELETE",
                ...
                {rows?.data?.map((row: any, index: any) => (
                  <tr key={index}>
                    ...
                    <td>
                      ...
                      >
                        <Link
                          href={`/dashboard/userManager/roles-permissions/role/update/${row.id}`}
                        >
                          Edit
                        </Link>
                        <Button
