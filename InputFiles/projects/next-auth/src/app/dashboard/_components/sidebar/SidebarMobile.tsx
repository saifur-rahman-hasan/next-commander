...
} from "@/app/dashboard/_interfaces/DashboardSidebarInterface";
import SidebarNavigationsList from "@/app/dashboard/_components/sidebar/SidebarNavigationsList";
import BrandLogo from "@/components/common/BrandLogo";



export default function SidebarMobile ({ navigations, sidebarOpen, setSidebarOpen }: DashboardSidebarComponentProps) {
	return (
