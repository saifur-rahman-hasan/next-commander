				...
				>
					...
					{user ? (
						<div className="hidden lg:flex lg:flex-1 lg:justify-end gap-x-4">
							<ProfileButton className="text-sm font-semibold leading-6 text-gray-900" />

							<LogoutButton className="text-sm font-semibold leading-6 text-gray-900" />
						</div>
					) : (
						<div className="hidden lg:flex lg:flex-1 lg:justify-end gap-x-4">
							<LoginButton className="text-sm font-semibold leading-6 text-gray-900" />

							<RegisterButton className="text-sm font-semibold leading-6 text-gray-900" />
						</div>
					)}
				</nav>
				<Dialog
